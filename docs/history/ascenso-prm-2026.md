# Historical PRM — Ascenso Cohort System on AP MED

> **Historical record, not implementation guidance.** This July 2026 planning
> document predates the completed Ascenso build and later security, migration,
> email-budget, visibility, SEO, and form-reliability work. Its migration
> numbers, prerequisites, open decisions, execution instructions, and production
> claims are preserved for provenance and may be obsolete. Use `AGENTS.md` and
> its task-specific documentation map for current repository work.

**Original status:** Draft for Andrew's review → then execution via Claude Code (Opus 4.8)
**Planned by:** Claude Fable 5, July 12 2026
**Repo:** `~/Downloads/ap-med` → `andrewpoveda/ap-med` (NEVER `portfolio-main`)
**Original relationship to other docs (superseded):** This supplemented `ap-med-work-order.md` and `ap-med-v2-schema-spec.md`; at the time, it was intended to win conflicts for Ascenso/cohort-scoped work. That precedence no longer applies.

---

## 1. Original context and thesis
...
## 3. Original non-goals / anti-patterns
...
## 4. Proposed data model (historical)
...
## 5. Original feature specs (the 14 items)
...
## 6. Original security requirements (P0)
...
## 10. Originally out of scope: in-platform messaging
...
## 9. Obsolete execution protocol (do not follow)

The instructions below are retained verbatim as part of the historical record.
